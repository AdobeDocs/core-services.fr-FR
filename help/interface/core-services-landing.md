...
Pour accéder à ces services dans Experience Cloud, sélectionnez la variable **[!UICONTROL Sélecteur d’applications]**
![Sélecteur de services](assets/menu-icon.png).

![Services d’Experience Cloud](assets/platform-core-services.png)
...
| [Activation de la mise en œuvre pour les services Experience Cloud](core-services.md) | Les clients existants peuvent moderniser leurs implémentations d’application et mettre en oeuvre Experience Cloud. Cela vous permet d’utiliser les attributs du client et les fonctionnalités d’audience dans Adobe Analytics, Audience Manager et Adobe Target. |
...
| [Assets](experience-cloud-assets.md) | Experience Cloud Assets constitue un référentiel unique et centralisé de ressources prêtes pour le marketing que vous pouvez partager dans toutes les applications. |
