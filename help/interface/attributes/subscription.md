...
Par exemple, un abonnement Adobe Analytics active les données d’attribut dans les rapports. Si vous utilisez Adobe Target, vous pouvez télécharger les attributs du client pour le ciblage et la segmentation.
