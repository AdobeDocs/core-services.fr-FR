...
# Adresses IP utilisées par CX Enterprise
...
* Serveurs de collecte de données pour tous les produits CX Enterprise
* Serveurs FTP pour tous les produits CX Enterprise
