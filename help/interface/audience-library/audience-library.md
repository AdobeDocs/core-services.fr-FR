---
description: Gérez la traduction des données du visiteur en segmentation d’audience dans la bibliothèque d’audiences Experience Cloud.
seo-description: Gérez la traduction des données du visiteur en segmentation d’audience dans la bibliothèque d’audiences Experience Cloud.
...
# Présentation des audiences Experience Cloud {#topic_679810123CAA4E0CA4FA3417FB0100C7}

Les audiences sont des collections de visiteurs (une liste d’identifiants visiteur). La bibliothèque d’Audiences d’Adobe vous permet de gérer la traduction des données visiteurs en segmentation des audiences. As such, creating and managing audiences is similar to creating and using segments, with the added ability to share the audience segment to products and services in [!DNL Experience Cloud].
