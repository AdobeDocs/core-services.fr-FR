...
Une *organisme* (ID d’organisation) est l’entité qui permet à un administrateur de configurer des groupes et des utilisateurs et de contrôler l’authentification unique dans l’Experience Cloud.

L’organisation fonctionne comme une société de connexion qui couvre tous les produits et applications Experience Cloud. La plupart du temps, une organisation désigne votre nom de société. Cependant, une société peut avoir plusieurs organisations.
...
Vous pouvez localiser l’ID d’organisation affecté à des fins d’assistance. Vous pouvez vérifier que vous vous trouvez dans la bonne organisation ou changer d’organisation à l’aide du menu **[!UICONTROL Organisation]**.
...
1. In [Experience Cloud](https://experience.adobe.com), appuyez sur **Ctrl+i** sur votre clavier.
...
1. Sous **[!UICONTROL Informations sur l’utilisateur]**, recherchez **[!UICONTROL ID d’organisation actuel]**, et l’ID d’organisation s’affiche.
   ...
   Les administrateurs peuvent également se connecter au Admin Console (accéder à [https://adminconsole.adobe.com](https://adminconsole.adobe.com)) et affichez l’identifiant de votre organisation dans l’URL.
...
1. Suivez les étapes de votre invitation par e-mail à un Experience Cloud.
