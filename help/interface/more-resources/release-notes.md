...
* **Attributs du client :** l’interface utilisateur des attributs du client affiche désormais des statuts supplémentaires des profils synchronisés dans Target. (MCUI-10231)
