...
| Fonctionnalité | Description |
|--- |--- |
| Notifications - Paramètres granulaires | Vous pouvez activer les notifications pour les événements et activités des produits et des applications, y compris les notifications sur lʼactivité de chargement [Attributs du client](../services/customer-attributes/attributes.md). |
...
* Lorsque vous accédez à `experience.adobe.com`, le processus d’ouverture de session est désormais cohérent avec l’ouverture d’une session Adobe Creative Cloud.
