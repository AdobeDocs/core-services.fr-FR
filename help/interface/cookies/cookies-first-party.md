...
Vous pouvez l’utiliser `nslookup` pour la validation. A l’aide `sstats.adobe.com`d’un exemple, ouvrez une invite de commande et saisissez `nslookup sstats.adobe.com`
