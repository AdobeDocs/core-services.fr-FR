...
1. Remplissez le formulaire ![de demande](assets/FPC_Request_Form.xlsx) et ouvrez un ticket avec le service à la clientèle demandant la configuration des cookies propriétaires dans le programme géré Adobe. Chaque champ est décrit avec des exemples dans le document.
