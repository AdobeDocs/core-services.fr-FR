...
* [Agent du support produit](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/new-features/customer-support) pour créer des tickets de support client, avec le contexte et les détails de session de vos interactions avec l’assistant AI.
