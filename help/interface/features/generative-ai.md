...
Ce type d’IA contraste avec l’[IA agentique](agentic-ai.md) (Adobe agentic framework), qui fait référence à l’IA qui fonctionne de manière autonome.
...
Voici un résumé des applications Experience Cloud qui utilisent GenAI, l’assistant d’IA ou l’IA dédiée aux agences. La compatibilité avec Adobe Firefly est indiquée.
...
| [Adobe Journey Optimizer](#journey-optimizer) | Non applicable | Disponible pour la connaissance des produits et les informations opérationnelles. | Non | [!BADGE En savoir plus]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/ai-assistant" tooltip="En savoir plus sur l’assistant AI dans AJO"} |
...
| [[!DNL Real-Time CDP]](#rtcdp) | Non applicable | Disponible pour la connaissance des produits à partir d’Experience League. Il offre également des informations opérationnelles (en version bêta). | Non | [!BADGE En savoir plus]{type=Informative url="https://experienceleague.adobe.com/fr/docs/experience-platform/ai-assistant/home" tooltip="En savoir plus sur Real-Time CDP"} |
