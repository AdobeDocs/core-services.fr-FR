...
L’IA générative est un type d’IA qui peut créer du contenu original, tel que du texte, des images, de la vidéo, de l’audio ou du code logiciel en réponse à l’invite ou à la demande d’un utilisateur.
...
* [Ressources d’IA responsables sur le Centre de gestion de la confidentialité](https://www.adobe.com/trust/responsible-ai.html)
