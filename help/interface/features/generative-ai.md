...
| **Adobe Experience Manager as a Cloud Service (AEM CS)** | L’IA est disponible dans :<ul><li>[Générer des variations](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor) dans **AEM Sites**</li><li>[GenAI](https://experienceleague.adobe.com/fr/docs/experience-manager-sites-optimizer/content/opportunity-types/overview) dans **Sites Optimizer**</li><li>[Content Hub](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en) et [Balises intelligentes](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags) dans **AEM Assets**</li></ul> [En savoir plus](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/generative-ai/generative-ai-in-aem) <br> | L’assistant AI est disponible pour : <ul><li>Page d’aperçu d’Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ressources</li><li>Formulaires</li><li>Dynamic Media</li><li>Cloud Manager</li></ul> [En savoir plus](https://experienceleague.adobe.com/fr/docs/experience-manager-cloud-service/content/ai-assistant/ai-assistant-in-aem) | Oui |
| **Adobe Experience Manager 6.5** | | L’assistant AI est disponible pour : <ul><li>Page d’aperçu d’Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ressources</li><li>Formulaires</li><li>Dynamic Media</li><li>Cloud Manager</li></ul> [En savoir plus](https://experienceleague.adobe.com/fr/docs/experience-manager-65/content/ai-assistant/ai-assistant-in-aem) | Oui |
| **Adobe Experience Manager 6.5 LTS** | | L’assistant AI est disponible pour : <ul><li>Page d’aperçu d’Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ressources</li><li>Formulaires</li><li>Dynamic Media</li><li>Cloud Manager</li></ul> [En savoir plus](https://experienceleague.adobe.com/fr/docs/experience-manager-65-lts/content/ai-assistant/ai-assistant-in-aem) | Oui |
| **Adobe Experience Platform** | | Disponible pour la connaissance des produits et les informations opérationnelles. [En savoir plus](https://experienceleague.adobe.com/fr/docs/experience-platform/ai-assistant/landing) | Non |
...
| **[!DNL Workfront]** |  | Disponible pour des informations et des suggestions in-app. [En savoir plus](https://experienceleague.adobe.com/fr/docs/workfront/using/basics/ai-assistant/ai-assistant-overview) | Oui |
