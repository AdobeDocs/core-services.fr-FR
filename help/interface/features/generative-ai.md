...
| | | AJO Prime et Ultimate proposent des [génération de contenu](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/content-management/ai-assistant/gs-generative?lang=en) pour apporter des suggestions proactives de variation de contenu pour le texte et les images. | Oui |
...
| [[!DNL Workfront]](#workfront) | Oui. <br> des informations et des suggestions in-app. [En savoir plus](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en) | Non applicable | Oui |
