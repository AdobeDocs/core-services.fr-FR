...
description: Obtenez un aperçu général des endroits où vous pouvez tirer parti des fonctionnalités optimisées par l’IA dans les applications Experience Cloud.
...
# IA générative dans Experience Cloud

L’IA générative (genAI) dans Experience Cloud vous permet d’automatiser les tâches créatives et cognitives et d’améliorer la productivité. Cette page vous aide à comprendre où les applications Experience Cloud prennent en charge genAI et l’assistant AI et fournit des liens pour en savoir plus sur ces fonctionnalités.

>[!IMPORTANT]
>
>Avant d’utiliser les fonctionnalités d’IA générative d’Experience Cloud, vous devez comprendre et suivre les [instructions d’utilisation de l’IA générative de Adobe Experience Cloud](https://www.adobe.com/fr/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html).
...
[!UICONTROL AI Assistant] est un outil genAI conversationnel pris en charge dans de nombreuses applications Experience Cloud. Utilisez-le pour acquérir rapidement des _connaissances sur les produits_ et _informations opérationnelles_, en fonction de l’application que vous utilisez.

* **Connaissances des produits :** les connaissances des produits font référence à des concepts et à des sujets reposant sur la documentation d’Experience League. Par exemple, utilisez les [invites basées sur les objectifs](https://experienceleague.adobe.com/fr/docs/experience-platform/ai-assistant/home) pour en savoir plus rapidement sur Experience Platform. Toutes les réponses d’Experience League sont vérifiables et citées avec des liens.
...
Voici un résumé des applications [!DNL Experience Cloud] qui utilisent les fonctionnalités d’IA générative et l’assistant d’IA. La compatibilité avec [Adobe Firefly](https://business.adobe.com/products/firefly-business/firefly-ai-approach.html) est indiquée pour les fonctionnalités d’IA génératives.

**Remarque :** les [!DNL Experience Platform Agents] sont décrites dans [IA dédiée aux agences dans Experience Cloud](agentic-ai.md).
...
| **Nom du produit** | **Fonctionnalités d’IA** | **Assistant IA** | **Compatibilité Firefly** |
|------------------|-------------------------|------------------|-------------------|
| **Adobe GenStudio for Performance Marketing** | GenStudio for Performance Marketing est une application genAI. Il permet aux équipes marketing et créatives de créer du contenu personnalisé sur la marque. [En savoir plus](https://experienceleague.adobe.com/fr/docs/genstudio-for-performance-marketing/user-guide/home) | Non applicable | Oui |
| **Adobe Experience Manager as a Cloud Service (AEM CS)** | L’IA est disponible dans :<ul><li>[Générer des variations](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor) dans **AEM Sites**</li><li>[GenAI](https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/opportunity-types/overview) dans **Sites Optimizer**</li><li>[Content Hub](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en) et [Balises intelligentes](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags) dans **AEM Assets**</li></ul> [En savoir plus](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generative-ai-in-aem) <br> | L’assistant AI est disponible pour : <ul><li>Page d’aperçu d’Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ressources</li><li>Formulaires</li><li>Dynamic Media</li><li>Cloud Manager</li></ul> [En savoir plus](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-assistant/ai-assistant-in-aem) | Oui |
| **Adobe Experience Manager 6.5** | | L’assistant AI est disponible pour : <ul><li>Page d’aperçu d’Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ressources</li><li>Formulaires</li><li>Dynamic Media</li><li>Cloud Manager</li></ul> [En savoir plus](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/ai-assistant/ai-assistant-in-aem) | Oui |
| **Adobe Experience Manager 6.5 LTS** | | L’assistant AI est disponible pour : <ul><li>Page d’aperçu d’Experience Hub<li>Edge Delivery Services</li><li>Sites</li><li>Ressources</li><li>Formulaires</li><li>Dynamic Media</li><li>Cloud Manager</li></ul> [En savoir plus](https://experienceleague.adobe.com/en/docs/experience-manager-65-lts/content/ai-assistant/ai-assistant-in-aem) | Oui |
| **Adobe Experience Platform** | | Disponible pour la connaissance des produits et les informations opérationnelles. [En savoir plus](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/landing) | Non |
| **Adobe Journey Optimizer** | | Disponible pour la connaissance des produits et les informations opérationnelles. [En savoir plus](https://experienceleague.adobe.com/fr/docs/journey-optimizer/using/get-started/ai-assistant) | Non |
...
| **Adobe Journey Optimizer B2B edition** |  | Disponible pour vous aider à mieux connaître les produits. [En savoir plus](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview) | Non |
| **[!DNL Campaign]Managed Cloud Services** |  | Disponible pour que l’accélérateur de contenu génère automatiquement du contenu personnalisé, attrayant et efficace en fonction des objectifs marketing sur plusieurs canaux tels que les e-mails, les SMS et les notifications push. [En savoir plus](https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs) | Oui |
| **[!DNL Customer Journey Analytics]** | L’IA est utilisée avec :<ul><li> [Légendes intelligentes](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions?lang=en) : pour obtenir des informations sur les visualisations Workspace les plus utilisées.</li><li>[Content Analytics](https://experienceleague.adobe.com/en/docs/analytics-platform/using/content-analytics/report/report?lang=en#template) : pour affecter automatiquement des métadonnées de ressource.</li></ul> | Disponible pour :<ul><li>[Connaissance des produits](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant?lang=en) (Experience League)</li><li>[Agent du support produit](agentic-ai.md) </li><li>[Data Insights Agent](agentic-ai.md)</li></ul> | Non |
| **Real-Time CDP** |  | Disponible pour la connaissance des produits à partir d’Experience League. Il offre également des informations opérationnelles. [En savoir plus](https://experienceleague.adobe.com/fr/docs/experience-platform/ai-assistant/home) | Non |
| **[!DNL Marketo]** | L’IA est disponible dans Email Designer (avec Firefly), [Dynamic Chat](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/generative-ai/overview?lang=en) et [webinaires interactifs](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en). | Disponible dans Marketo Engage [Email Designer](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/email-designer/ai-assistant) | Oui |
| **[!DNL Workfront]** |  | Disponible pour des informations et des suggestions in-app. [En savoir plus](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview) | Oui |

## Comment utiliser l’IA générative dans Experience Cloud ? {#products}
...
[!BADGE En savoir plus]{type=Informative url="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/email-designer/ai-assistant" tooltip="En savoir plus sur Dynamic Chat"}
