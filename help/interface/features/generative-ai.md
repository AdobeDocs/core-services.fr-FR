...
description: Trouvez de l’aide sur l’IA générative (GenAI) et l’assistant IA dans les applications Experience Cloud.
...
* **Connaissances des produits :** les connaissances des produits font référence à des concepts et à des sujets reposant sur la documentation d’Experience League. [ Par exemple, découvrez comment créer des invites efficaces et basées sur les objectifs ](https://experienceleague.adobe.com/fr/docs/experience-platform/ai-assistant/home) tirer le meilleur parti d&#39;Experience Platform. Toutes les réponses d’Experience League sont vérifiables et citées avec des liens.
...
>[!NOTE]
>
>De nombreuses applications Experience Cloud proposent _assistant AI_ comme nom de fonctionnalité (comme décrit ci-dessous). Cependant, cette fonctionnalité extrait les informations uniquement pour l’application spécifique que vous utilisez. Par exemple, l’assistant AI dans AEM ne fournit que des informations pertinentes et utiles relatives à AEM.
...
## Quelles fonctionnalités d’IA sont prises en charge dans Experience Cloud ? {#ai-roundup}

Voici un résumé des applications Experience Cloud qui utilisent des fonctionnalités optimisées par l’IA, l’assistant IA ou l’IA dédiée aux agences. La compatibilité avec [Adobe Firefly](https://business.adobe.com/products/firefly-business/firefly-ai-approach.html) est indiquée.
