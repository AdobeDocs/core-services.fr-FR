...
Adobe [!DNL Experience Platform] [Agent Orchestrator](https://experienceleague.adobe.com/fr/docs/experience-cloud-ai/experience-cloud-ai/home) est la technologie centrale de création et de coordination des agents d’IA experts dans Adobe [!DNL Experience Cloud].

Vous pouvez accéder aux agents d’IA par l’un des moyens suivants :

* [Existing [!DNL Experience Cloud] apps](#existing-apps) (Une licence est requise pour utiliser un agent d’IA)
* [AI-First [!DNL Experience Cloud] apps](#ai-first-apps) (Les agents sont natifs de l’application)

## Applications [!DNL Experience Cloud] existantes

Les applications existantes fonctionnent par elles-mêmes, mais l’ajout d’agents d’IA vous donne plus de puissance et d’impact. Si vous possédez une licence pour [!DNL Platform Agent Orchestrator], vous pouvez utiliser le [!DNL Platform Agents] pour les applications auxquelles vous avez droit.
...
| [Data Insights Agent](https://experienceleague.adobe.com/fr/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai) | Disponible | Répondez aux questions sur les données et créez des visualisations dans Analysis Workspace. | <ul><li>Customer Journey Analytics</li></ul> |
...
## Applications Experience Cloud axées sur l’IA

Ces applications sont conçues avec l’IA au cœur. Ils utilisent l’IA générative ou agentique pour les tâches essentielles, et les agents d’IA sont déjà inclus dans la licence de l’application sans avoir besoin du module complémentaire Agent Orchestrator.
