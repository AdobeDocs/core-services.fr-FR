...
description: Découvrez les profils utilisateur, les préférences de compte et les données d’utilisation des produits dans CX Enterprise. Abonnez-vous aux notifications de produits pour les e-mails et les [!DNL Slack], et configurez des alertes de produits.
...
Pour trouver les préférences CX Enterprise, cliquez sur **[!UICONTROL Profile]** ![preferences](../assets/preferences-icon-sm.png) dans l&#39;en-tête, puis cliquez sur **[!UICONTROL Preferences]**.

![préférences](../assets/preferences-navigation.png){width="100" zoomable="yes"}

Sur la page [!UICONTROL Préférences CX Enterprise], vous pouvez gérer les fonctionnalités de compte suivantes :
...
## [!UICONTROL Données d’utilisation du produit]
...
* la façon dont vous interagissez avec les applications Adobe CX Enterprise, y compris les fonctionnalités que vous utilisez et les options que vous sélectionnez ;
...
## Abonnement aux notifications dans CX Enterprise
...
Les notifications par e-mail et Slack sont utiles dans les cas où vous n’êtes pas connecté à CX Enterprise.

### Abonnement aux notifications in-app et par e-mail

1. Accédez à CX Enterprise [préférences](https://experience.adobe.com/preferences).
...
Vous pouvez configurer les préférences de votre compte pour envoyer des notifications CX Enterprise à un canal [!DNL Slack].

**Conditions préalables**

* Vous devez disposer d&#39;un compte CX Enterprise.
* Vous devez disposer d&#39;un compte [!DNL Slack]. Votre administrateur [!DNL Slack] permet l’intégration de l’entreprise CX à [!DNL Slack].
...
Si [!DNL Slack] n’est pas installé, un message _[!UICONTROL Demande d’installation]_ s’affiche lorsque Slack s’ouvre après avoir cliqué sur **[!UICONTROL Ajouter à Slack]**. Par exemple :
...
1. Une fois que vous avez reçu l’approbation [!DNL Slack], revenez à CX Enterprise **[!UICONTROL Notifications]** et suivez les étapes pour [vous abonner à Slack](#slack-notifications) (décrites ci-dessus).
...
* Le message personnel sera reçu du nom de l&#39;application _Adobe[!DNL CX Enterprise]_.
...
* Un lien pour afficher toutes les notifications sur CX Enterprise.
* Lien permettant de gérer les préférences de notification sur CX Enterprise.

## Afficher [!UICONTROL notifications] et annonces dans CX Enterprise

Dans l’en-tête du [!DNL CX Enterprise], vous pouvez afficher les notifications auxquelles vous [vous êtes abonné](#notifications), ainsi que les annonces.
