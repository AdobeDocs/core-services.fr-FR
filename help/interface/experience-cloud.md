---
description: Découvrez les composants de l’interface centrale de CX Enterprise (anciennement Experience Cloud). Obtenez de l’aide sur l’administration des utilisateurs et des produits, activez des applications pour les services d’interface partagée. Obtenez de l’aide sur la bibliothèque d’audiences, les attributs du client, Assets, etc.
title: Guide d’interface et d’administration de CX Enterprise
