---
description: Découvrez les sources de données des solutions et comment configurer les abonnements. Les abonnements activent le flux de données d’attributs du client entre l’Experience Cloud et les applications (Analytics et Target).
...
Découvrez les sources de données des applications et comment configurer les abonnements. Les abonnements activent [!DNL Customer Attribute] flux de données entre l’Experience Cloud et les applications ([!DNL Analytics] et [!DNL Target]).
