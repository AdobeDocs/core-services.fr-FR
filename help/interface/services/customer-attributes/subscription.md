...
Découvrez les sources de données des applications et comment configurer les abonnements. Les abonnements activent le flux de données [!DNL Customer Attribute] entre l’Experience Cloud et les applications ([!DNL Analytics] et [!DNL Target]).
