...
| La migration vers le service Experience Cloud ID est-elle requise ? | La migration dépend des applications que vous utilisez. <ul><li>Adobe Analytics : fortement recommandé </li><li>Adobe Target : obligatoire. </li></ul><br>L’utilisation du service d’ID d’Experience Cloud permet d’accéder aux dernières fonctionnalités de l’Experience Cloud, notamment les audiences en temps réel, la modernisation d’Adobe Target, l’intégration d’Analytics et le suivi de pulsation vidéo. |
